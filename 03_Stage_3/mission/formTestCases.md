## ✅ Casos de Prueba Challenge 1 y 2
...
### **Scenario: CP02 - Ingresar numero de teléfono con formato inválido**
*   **Given:** el usuario navega a la página principal de registro utilizando un email válido.
...
### **Scenario: CP03 - Verificar validación cuando el campo email está vacío**
*   **Given:** el usuario navega a la página principal de registro utilizando un email válido.
